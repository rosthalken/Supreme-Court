...
#Changed from NumWords to NumPhrase--might be wrong
word_threshold <- 500
...
```{r, echo=FALSE, message=FALSE}
knitr::kable(by_author, col.names = c("Justice", "Documents"), caption = "Documents by Justice with > 1000 Ngrams")
```
